/**
 * Two artifacts: `lib/index.js` (Node half, ESM, dsh packages external, jsdiff inlined) and
...
export default defineConfig([
  {
    ...
    sourcemap: true,
    clean: false,
    // jsdiff is inlined so the installed plugin has no runtime dependencies.
    deps: { alwaysBundle: ['diff'], onlyBundle: ['diff'] },
  },
  {
    name: `${ID}/client`,
